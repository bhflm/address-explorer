        ...
        <div className="m-8">
          ...
          <div className="searchbar sm:mt-12 flex justify-center">
            <div className="flex flex-col items-center sm:w-1/3">
                <Input className="w-full truncate hover:text-clip sm:w-1/2" type="address" placeholder="Address" onChange={(e) => {
                  setAddress(e.target.value);
                  handleInputChange();
                }} />
                <Button className="border-0.5 mt-4 sm:w-1/3" type="submit" onClick={() => handleSearch()}>Search</Button>
